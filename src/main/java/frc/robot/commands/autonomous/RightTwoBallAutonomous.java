...
public class RightTwoBallAutonomous extends SequentialCommandGroup {
  ...
  private final Trajectory cargoTwoTrajectory = TrajectoryGenerator.generateTrajectory(
    ...
    List.of(
      new Translation2d(-2.2/2 ,0.25/2)
    ),

    new Pose2d(-2.2,0.25,Rotation2d.fromDegrees(0.0)),
  ...
  public RightTwoBallAutonomous(Launcher m_launcher, Drivetrain m_drivetrain, Intake m_intake) {
